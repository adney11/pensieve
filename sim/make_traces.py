...
for i in range(0, 66):
    ...
    os.system("python3 synthetic_traces.py " + str(random.uniform(10, 100)) + " " + str(random.uniform(1,5)) + " " + str(random.uniform(0.05, 0.5)) + " 2000 > " + name)

# generate 205 files, each 320 seconds for testing
for i in range(0, 205):
    name = "synthetic_traces_complete/testing/trace" + str(i) + ".txt"
    os.system("python3 synthetic_traces.py " + str(random.uniform(10, 100)) + " " + str(random.uniform(1,5)) + " " + str(random.uniform(0.05, 0.5)) + " 320 > " + name)
